...
// export const createProfile = (profileData: IProfile, userId: string) => {
//   return async function (dispatch: Function) {
//     dispatch({
//       type: loaderTypes.SHOW_LOADER,
//     });
//     try {
//       const newProfile = await createProfileInfo(profileData);
//       dispatch({
...
// export const updateProfile = (id: string, updatedData: IProfile, userId: string) => {
//   return async function (dispatch: Function) {
//     dispatch({
//       type: loaderTypes.SHOW_LOADER,
//     });
